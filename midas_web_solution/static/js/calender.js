/**
 * Created by znxkz on 2017-05-27.
 */
...
function kCalendar(id, date) {
    ...
    for (var i = 0; i < week; i++) {
        ...
        for (var j = 0; j < 7; j++, dateNum++) {
            ...
            calendar += '            <td class="' + dateString[j] + '" style="cursor:pointer" onclick="clickDate(' + currentYear + ', ' + currentMonth + ', ' + dateNum + ')" >'
                + dateNum +
                '<hr><div class="jusik"> morning: ' + 'morning' + ' <br>' +
                ' lunch: ' + 'lunch' + ' <br>' +
                ' dinner: ' + 'dinner' + ' </div>' +
                '</td>';
        }
